...
NB. cal - tabz.ijs
'==================== [cal] tabz.ijs ===================='
NB. Utilities and data for TABULA which are to reside in z locale

NB. >>>>>>>>>>>> NOT BUILT (kept in /source/ for reference only) <<<<<<<<<<<<<<
...
BB=: LL			NB. (use as) empty boxed list also
	...
	NB. FIXED BY IAC: Thursday 16 March 2017
	NB. Generic interconversions of form: any2* (alias: a2*)
any2b=:	a2b=:	3 : '". :: BB ''2b y'',~zutype y'
any2o=:	a2o=:	3 : '". :: LL ''2o y'',~zutype y'
any2x=:	a2x=:	3 : '". :: MM ''2x y'',~zutype y'
any2f=:	a2f=:	3 : '". :: LL ''2f y'',~zutype y'
