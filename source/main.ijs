...
0 :0   NB. OLD facility: Saturday 22 December 2018  20:45:21
plotv=: 4 : 0
...
plot2Swift y -.~ }.items''   NB. y-arg is items to be plotted
)
...
plot2Swift rrr -. IX     NB. y-arg is items to be plotted (exclude IX)
catch.
...
remove_infinities=: 3 : 0
  NB. used only by: plotz, plotxSwift in CAL
f1=. 3 : '(>./y -. _) (I. y=_)}y' "1
